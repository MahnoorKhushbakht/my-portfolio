      ...
      <div className="container px-3 py-8 mx-auto flex items-center sm:flex-row flex-col">
        {/* <a className="flex title-font font-medium items-center md:justify-start justify-center">
          <Image
            ...
            className="shadow-sm"
          />
          <span className="ml-3 text-xl text-gray-200">Mahnoor Khushbakht</span>
        </a> */}
<p className="text-sm text-gray-200  sm:py-2 sm:mt-0 mt-4">
  © 2024 Crafted By Mahnoor Khushbakht.  
  {/* <a href="#" className="text-gray-200 ml-1">
    All Rights Reserved.
  </a> */}
</p>

        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          <a href="https://www.facebook.com/mahnoor.khushbakht?mibextid=ZbWKwL" className="text-gray-200" aria-label="Facebook">
          ...
          <a href="https://www.instagram.com/mahnoor.khushbakht" className="ml-3 text-gray-200" aria-label="Instagram">
            <svg fill="none" stroke="currentColor" className="w-5 h-5" viewBox="0 0 24 24">
              <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
              <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
            </svg>
          </a>
          <a href="https://www.linkedin.com/in/mahnoorkhushbakht/" className="ml-3 text-gray-200" aria-label="Linkedin">
            <svg fill="currentColor" className="w-5 h-5" viewBox="0 0 24 24">
              <path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z"></path>
              <circle cx="4" cy="4" r="2"></circle>
            </svg>
          </a>
          <a href="mahnoorkhushbakht@gmail.com" className="ml-3 text-gray-200" aria-label="Gmail">
    <svg fill="currentColor" className="w-5 h-5" viewBox="0 0 24 24">
      <path d="M22 6.5V17a2.5 2.5 0 01-2.5 2.5H4.5A2.5 2.5 0 012 17V6.5l10 7 10-7z"></path>
      <path d="M2 6.5L12 2l10 4.5"></path>
    </svg>
  </a>
  <a href="https://github.com/MahnoorKhushbakht" className="ml-3 text-gray-200" aria-label="Github">
    <svg fill="currentColor" className="w-5 h-5" viewBox="0 0 24 24">
